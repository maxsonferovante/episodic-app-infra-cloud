...
resource "aws_api_gateway_method" "releases_get" {
  rest_api_id   = aws_api_gateway_rest_api.this.id
...
resource "aws_api_gateway_integration" "releases_lambda" {
  rest_api_id             = aws_api_gateway_rest_api.this.id
  resource_id             = aws_api_gateway_resource.releases.id
  http_method             = aws_api_gateway_method.releases_get.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = var.dashboard_lambda_invoke_arn
}
...
# Releases OPTIONS
resource "aws_api_gateway_method" "releases_options" {
  rest_api_id   = aws_api_gateway_rest_api.this.id
  resource_id   = aws_api_gateway_resource.releases.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "releases_options" {
  rest_api_id = aws_api_gateway_rest_api.this.id
  resource_id = aws_api_gateway_resource.releases.id
  http_method = aws_api_gateway_method.releases_options.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "releases_options_200" {
  rest_api_id = aws_api_gateway_rest_api.this.id
  resource_id = aws_api_gateway_resource.releases.id
  http_method = aws_api_gateway_method.releases_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "releases_options" {
  rest_api_id = aws_api_gateway_rest_api.this.id
  resource_id = aws_api_gateway_resource.releases.id
  http_method = aws_api_gateway_method.releases_options.http_method
  status_code = aws_api_gateway_method_response.releases_options_200.status_code
